...
import { BadgeCounts, Badges } from "@/types/global";
...
const StatsCard = ({ imgUrl, value, title }: StatsCardProps) => (
  <div className="light-border background-light900_dark300 shadow-light-300 dark:shadow-dark-200 flex items-center justify-start gap-4 rounded-md border p-6 md:flex-wrap">
    <Image
      src={imgUrl}
      alt={title}
      width={40}
